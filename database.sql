-- Create the database
CREATE DATABASE IF NOT EXISTS krili_db;
USE krili_db;
...
('fuck.realmadrid@example.com', '$2a$10$X7UrH5YxX5YxX5YxX5YxXO', 'Real', 'Madrid', '+1234567890', TRUE);

-- Sample social login connections
...
DELIMITER //
CREATE PROCEDURE user_login(IN p_email VARCHAR(255), IN p_password VARCHAR(255))
BEGIN
...
BEGIN
    ...
    ELSE
        ...
        VALUES (p_email, p_password, p_first_name, p_last_name, p_phone_number);
